function processmodel(pm)
    ...
    if includeGenerateCodeTask && includeAnalyzeModelCode
        if padv.internal.vercheck.is26aOrLater
            configFile = 'CodingRulesOnly_config.psprjx';
        else
            configFile = 'CodingRulesOnly_config.psprj';
        end
        ...
        psbfTask.addInputQueries(padv.builtin.query.FindFileWithAddress( ...
            Type='ps_prj_file',Path=fullfile('tools',configFile)));
